    ...
    try {
      ...
      if (response.ok) {
        ...
        setDesign(prev => ({
          ...prev,
          ...data,
          showTotalSavings: data.showTotalSavings ?? prev.showTotalSavings,
          totalSavingsText: data.totalSavingsText || prev.totalSavingsText,
          showEstimatedTotal: data.showEstimatedTotal ?? prev.showEstimatedTotal,
          estimatedTotalText: data.estimatedTotalText || prev.estimatedTotalText,
        }));
      }
    } catch (error) {
